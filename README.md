...
The Dismembering Framework enhances Skyrim combat with real-time dismemberment, realistic blood splatters, and adaptive sound effects based on armor and weapon types. It operates directly through the game engine for a seamless experience, includes extensive customization options via the MCM menu, and integrates smoothly with other mods.

The mod can be downloaded here: [nexusmods.com](https://www.nexusmods.com/skyrimspecialedition/mods/126203)
